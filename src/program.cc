...
void t_type_of<t_program>::f_define(t_library* a_library)
{
	t_define{a_library}
...
t_pvalue t_type_of<t_program>::f_do_construct(t_pvalue* a_stack, size_t a_n)
{
	return t_construct_with<t_object*(*)(t_type*), t_program::f_new<glCreateProgram>>::f_do(this, a_stack, a_n);
}
