...
void t_type_of<xemmaix::gl::t_program>::f_define(t_extension* a_extension)
{
	...
	t_define<t_program, t_object>(a_extension, L"Program"sv)
		...
		(L"get_active_attrib"sv, t_member<t_scoped(t_program::*)(GLuint) const, &t_program::f_get_active_attrib>())
		(L"get_active_uniform"sv, t_member<t_scoped(t_program::*)(GLuint) const, &t_program::f_get_active_uniform>())
		(L"get_attached_shaders"sv, t_member<t_scoped(t_program::*)() const, &t_program::f_get_attached_shaders>())
		...
		(L"get_uniformfv"sv, t_member<t_scoped(t_program::*)(const t_uniform_location&) const, &t_program::f_get_uniformfv>())
		(L"get_uniformiv"sv, t_member<t_scoped(t_program::*)(const t_uniform_location&) const, &t_program::f_get_uniformiv>())
