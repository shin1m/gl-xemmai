...
std::vector<std::pair<t_root, t_rvalue>> t_library::f_define()
{
	...
	return t_define(this)
		(L"Int16Array"sv, static_cast<t_object*>(v_type_array_of_int16))
		(L"Int32Array"sv, static_cast<t_object*>(v_type_array_of_int32))
		(L"Float32Array"sv, static_cast<t_object*>(v_type_array_of_float32))
		(L"Error"sv, static_cast<t_object*>(v_type_error))
		(L"Buffer"sv, static_cast<t_object*>(v_type_buffer))
		(L"Framebuffer"sv, static_cast<t_object*>(v_type_framebuffer))
		(L"Renderbuffer"sv, static_cast<t_object*>(v_type_renderbuffer))
		(L"Texture"sv, static_cast<t_object*>(v_type_texture))
		(L"Program"sv, static_cast<t_object*>(v_type_program))
		(L"Shader"sv, static_cast<t_object*>(v_type_shader))
		(L"UniformLocation"sv, static_cast<t_object*>(v_type_uniform_location))
