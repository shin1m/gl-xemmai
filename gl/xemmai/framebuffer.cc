...
t_transfer t_type_of<t_framebuffer>::f_construct(t_object* a_class, t_slot* a_stack, size_t a_n)
{
	return t_construct_with<t_transfer (*)(t_object*), t_framebuffer::f_construct>::t_bind<t_framebuffer>::f_do(a_class, a_stack, a_n);
}
